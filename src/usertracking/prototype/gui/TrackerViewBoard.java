...
public class TrackerViewBoard extends JFrame {
	...
	private SkeletonFrontView leftViewer;
	private SkeletonSideView centerViewer;
	...
	private void prepareGUI() {
		...
		leftViewer = new SkeletonFrontView(tracker);
		centerViewer = new SkeletonSideView(tracker);
		
		topViewer = new SkeletonTopView(tracker);
		topViewer.setPreferredSize(new Dimension(1000, 400));
		
		infoViewer = new SkeletonTextInfoView(20,10);
