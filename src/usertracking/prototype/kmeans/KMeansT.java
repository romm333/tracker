...
public class KMeansT implements Clusterer{
	/**
     ...
     */
    public KMeansT(int clusters, int iterations) {
     ...
     */
    public KMeansT(int clusters, int iterations, DistanceMeasure dm) {
